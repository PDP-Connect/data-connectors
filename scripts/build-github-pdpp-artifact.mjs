  ...
  try {
    const archive = execFileSync(
      ...
      [
        ...
        "--format=tar",
        EXPECTED_COMMIT,
        ...upstreamConnectorFiles,
        "packages/polyfill-connectors/src",
      ],
      { cwd: pdppRoot, maxBuffer: 64 * 1024 * 1024 },
    );
    execFileSync("tar", ["-xf", "-", "-C", pinnedRoot], {
      input: archive,
    ...
    const upstreamRuntimeRoot = join(pinnedRoot, "packages", "polyfill-connectors", "src");
