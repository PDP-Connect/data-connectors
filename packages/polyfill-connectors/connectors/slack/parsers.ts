 ...
 */
export function buildChannelStatsRecord(
	r: ChannelRow,
	observedOn: string,
): RecordData {
	const d = parseBlob(r.data);
...
function userProfileFields(
	profile: NonNullable<SlackDataBlob["profile"]>,
...
export function buildMessageAttachmentRecords(
 ...
 */
export function buildChannelCanvasIndex(
	chanRows: readonly ChannelRow[],
): Map<string, ChannelCanvasMeta> {
 ...
 */
export function selectCommittedMaxTs(
	priorMaxTs: string | null,
	runMaxTs: string | null,
): string | null {
