...
function record(
	stream: string,
	key: string,
	emittedAt = "2026-08-13T10:00:01.000Z",
): EmittedMessage {
	return {
		type: "RECORD",
		stream,
...
test("buildRunSummary: latest_record_emitted_at reflects the latest RECORD.emitted_at across streams", () => {
	...
	assert.equal(
		summary.done.latest_record_emitted_at,
...
test("buildRunSummary: derives per-stream elapsed time from RECORD timestamps", () => {
		...
		[
			{
				...
				key: "a",
				data: {},
				emitted_at: "2026-08-13T10:00:00.000Z",
			},
			{
				type: "RECORD",
				stream: "slow",
				key: "b",
				data: {},
				emitted_at: "2026-08-13T10:05:00.000Z",
			},
			{
				type: "RECORD",
				stream: "fast",
				key: "c",
				data: {},
				emitted_at: "2026-08-13T10:00:10.000Z",
			},
			{ type: "DONE", status: "succeeded", records_emitted: 3 },
	...
	assert.equal(
		summary.streams.slow?.first_record_at,
		"2026-08-13T10:00:00.000Z",
	);
	assert.equal(
		summary.streams.slow?.last_record_at,
