...
test("connector manifest streams: coverage_policy uses only valid enum values", () => {
	...
	assert.deepEqual(
		violations,
		[],
		"All declared coverage_policy values must be in the recognized enum",
	);
});
...
const KNOWN_MISSING_REQUIRED = new Map([
	...
	["slack.messages", "3679539216215eaf"],
	...
	["usaa.account_stats", "6e2bfff947a4439b"],
	...
	["usaa.credit_card_billing_stats", "0d0030ccbfe038e4"],
	...
	["ynab.account_stats", "97b5e61008b1e538"],
